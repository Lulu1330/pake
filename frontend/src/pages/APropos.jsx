...
export default function APropos() {
    ...
    <div className="max-w-3xl mx-auto p-6 text-left font-sans text-gray-800">
      <h1 className="text-4xl font-extrabold text-indigo-600 mb-6">🃏 À propos de Pake de Cartes</h1>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-bold text-purple-600 mb-2">🎯 Objectif du jeu</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-bold text-purple-600 mb-2">👥 Pour qui ?</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-bold text-purple-600 mb-2">💡 Pourquoi ce jeu ?</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-bold text-purple-600 mb-2">🛠️ Techniquement</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-bold text-purple-600 mb-2">✉️ Une suggestion ? Un bug ?</h2>
        <p>
